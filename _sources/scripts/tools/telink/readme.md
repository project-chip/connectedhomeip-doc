...
3. Then flash the `factory_data.bin` generated from the generator tool at
   specific address:
    ...
    > [2 MB flash](https://github.com/project-chip/connectedhomeip/blob/master/src/platform/telink/tlsr9518adk80d_2m_flash.overlay)
    > it is `0xff000` and for
    > [4 MB flash](https://github.com/project-chip/connectedhomeip/blob/master/src/platform/telink/tlsr9518adk80d_4m_flash.overlay)
