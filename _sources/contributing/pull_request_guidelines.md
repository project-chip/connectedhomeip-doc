...
-   [ ] Consistent style
    ...
    -   can use the [style guilde](../../../contributing/style/CODING_STYLE_GUIDE.md) for reference
        (note that
...
-   If changing common code, check where any RAM/FLASH overhead comes from. You
    can use [size tooling](https://github.com/project-chip/connectedhomeip/blob/master/scripts/tools/ELF_SIZE_TOOLING.md) to gather this
    information.
