...
[`CustomerAppTask.h`](https://github.com/project-chip/connectedhomeip/blob/master/examples/platform/silabs/customer/CustomerAppTask.h) and
[`CustomerAppTask.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/platform/silabs/customer/CustomerAppTask.cpp) for
that purpose. The base implementation and the full set of overridable `*Impl()`
APIs live in this example's source tree under
[`include/AppTaskImpl.h`](https://github.com/project-chip/connectedhomeip/blob/master/examples/evse-app/silabs/include/AppTaskImpl.h) and
[`src/AppTask.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/evse-app/silabs/src/AppTask.cpp). Any `*Impl()` you do not override keeps
the Silicon Labs default behavior. To customize behavior, copy
[`CustomerAppTask.h`](https://github.com/project-chip/connectedhomeip/blob/master/examples/platform/silabs/customer/CustomerAppTask.h) and
[`CustomerAppTask.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/platform/silabs/customer/CustomerAppTask.cpp) from
...
[`include/`](https://github.com/project-chip/connectedhomeip/blob/master/examples/evse-app/silabs/include/AppTaskImpl.h) and [`src/`](https://github.com/project-chip/connectedhomeip/blob/master/src/AppTask.cpp). Use them as
the reference for overridable methods and app configuration.

| File                                             | Purpose                                                                                                                                              |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`include/AppTaskImpl.h`](https://github.com/project-chip/connectedhomeip/blob/master/examples/evse-app/silabs/include/AppTaskImpl.h) | Declarations of every overridable `*Impl()` method. Copy the signatures you need from here into `CustomerAppTask.h`.                                 |
| [`src/AppTask.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/evse-app/silabs/src/AppTask.cpp)             | Silicon Labs default implementation of AppTask. This is what runs for any `*Impl()` you do not override. Use as reference when customizing behavior. |
...
-   [`examples/energy-management/electrical-sensor/src/ElectricalEnergyMeasurementDelegateImpl.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/energy-management/electrical-sensor/src/ElectricalEnergyMeasurementDelegateImpl.cpp)
-   [`examples/energy-management/electrical-sensor/src/ElectricalPowerMeasurementDelegateImpl.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/energy-management/electrical-sensor/src/ElectricalPowerMeasurementDelegateImpl.cpp)
-   [`examples/energy-management/electrical-sensor/src/PowerTopologyDelegateImpl.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/energy-management/electrical-sensor/src/PowerTopologyDelegateImpl.cpp)
