...
-   `-mfd`, enable Matter factory data feature, which load factory data from
    `MFD` partition
    -   Please refer to
        [Bouffalo Lab Matter factory data guide](../../../platforms/bouffalolab/matter_factory_data.md)
...
[guide](../../../platforms/openthread/openthread_border_router_pi.md) to
...
-   Add Matter recognition header by
    [ota_image_tool.py](../../../platforms/openthread/openthread_border_router_pi.md).
