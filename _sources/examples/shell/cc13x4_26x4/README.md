...
A [chip-shell](https://github.com/project-chip/connectedhomeip/blob/master/README.md) project on the Texas Instruments CC13XX_26XX family
of Wireless MCUs.
...
[shell example README](https://github.com/project-chip/connectedhomeip/blob/master/README.md).
