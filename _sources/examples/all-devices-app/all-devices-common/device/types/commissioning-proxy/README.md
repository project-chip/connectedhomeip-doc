...
[`src/app/clusters/commissioning-proxy-server/README.md`](https://github.com/project-chip/connectedhomeip/blob/master/src/app/clusters/commissioning-proxy-server/README.md).
...
[`posix/linux/CommissioningProxyPafAdapter.cpp`](https://github.com/project-chip/connectedhomeip/blob/master/examples/all-devices-app/posix/linux/CommissioningProxyPafAdapter.cpp):
