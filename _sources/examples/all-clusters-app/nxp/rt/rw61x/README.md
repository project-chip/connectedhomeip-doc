...
-   Follow instruction in [BUILDING.md](../../../../../guides/BUILDING.md)
...
-   Download
    ...
    ![MCUXpresso SDK Download](../../../../../../../../examples/platform/nxp/rt/rw61x/doc/images/mcux-sdk-download.PNG)
...
-   To build with the option to have Matter certificates/keys pre-loaded in a
    ...
    [Guide for writing manufacturing data on NXP devices](../../../../../guides/nxp_manufacturing_flow.md).
-   To build the application with the OTA Requestor enabled, the arguments
    ...
    [OTA Requestor README](../../../../../guides/nxp_rw61x_ota_software_update.md)
...
dedicated guide
['Matter Over-The-Air Software Update with NXP RW61x example applications'](../../../../../guides/nxp_rw61x_ota_software_update.md).
