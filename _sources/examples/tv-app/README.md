...
1. The **declared** device type — endpoint 1's `deviceType` in
   [tv-common/tv-app.matter](https://github.com/project-chip/connectedhomeip/blob/master/examples/tv-app/tv-common/tv-app.matter) / `tv-app.zap`, surfaced
...
2. The **advertised** device type — the compile-time
   ...
   [tv-common/include/CHIPProjectAppConfig.h](https://github.com/project-chip/connectedhomeip/blob/master/examples/tv-app/tv-common/include/CHIPProjectAppConfig.h),
